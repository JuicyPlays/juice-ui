...
const SlipComponent = ({ slips }) => {
    ...
    return (
      <div style={styles.empty}>
        ...
        <p style={styles.emptySubText}>
          Try adjusting your filters or generating again.
        </p>
      </div>
    );
  }
  ...
  const sortedSlips = [...slips].sort(
    (a, b) => (b.evPercent || 0) - (a.evPercent || 0)
  );
  ...
  const formatDate = (dateStr) => {
    ...
    try {
      ...
      if (isToday) {
        ...
        return (
          date.toLocaleDateString([], { weekday: "short" }) + " " + timeStr
        );
      }
    } catch (e) {
      return "";
                  ...
                  <div style={styles.headerTypeInfo}>
                    ...
                    >
                      <div style={styles.slipTypeHead}>
                        <span style={styles.powerIcon}>🔮</span> POWER{" "}
                        {slip.size}
                      </div>
                      <div
                        style={{
                          ...
                          background:
                            slip.evPercent >= 10
                              ...
                              : styles.evPill.background,
                          boxShadow:
                            slip.evPercent >= 10
                              ? "0 0 12px rgba(16, 185, 129, 0.4)"
                              : styles.evPill.boxShadow,
                        }}
                      >
                ...
                <div className="slip-header-right" style={styles.headerRight}>
                  <div style={styles.payoutCol}>
                    <div style={styles.payoutVal}>
                      {slip.hitProb !== undefined
                        ? slip.hitProb.toFixed(1)
                        : (
                            slip.picks.reduce(
                              (acc, p) => acc * ((p.prob || 50) / 100),
                              1
                            ) * 100
                          ).toFixed(1)}
                      %
                  ...
                  <div style={styles.payoutCol}>
                    <div style={styles.payoutVal}>
                      {slip.payout ? `${slip.payout}x` : getPayout(slip.size)}
                    </div>
                  ...
                  {slip.picks.map((pick, j) => (
                    <div key={j} style={styles.mobileCardRow}>
                      <div style={styles.mobileCardHeader}>
                        ...
                        />
                        <span
                          style={{ ...styles.sportBadge, marginLeft: "auto" }}
                        >
                          {pick.sport}
                        </span>
                      </div>
                      ...
                      <div
                        style={{ ...styles.mobileDetailGrid, marginTop: "4px" }}
                      >
                        <span style={styles.mobileBookChip}>
                          Book: {pick.sportsbookLine}
                        </span>
                        <span style={styles.mobileModelChip}>
                          Model: {pick.modelLine}
                        </span>
                        <span
                          style={
                            pick.over
                              ? styles.mobileLeanOver
                              : styles.mobileLeanUnder
                          }
                        >
                  ...
                  <div style={styles.picksContainer}>
                    {slip.picks.map((pick, j) => (
                      ...
                      >
                        ...
                        >
                          <div style={styles.targetLinePill}>
                            {pick.sportsbookLine}
                          </div>
                        </div>
                        <div
                        ...
                        >
                          <div style={styles.modelLinePill}>
                            {pick.modelLine}
                          </div>
                        </div>
                        <div
                        ...
                        >
                          <span
                            style={
                              pick.over ? styles.leanOver : styles.leanUnder
                            }
                          >
                            {pick.over ? "OVER" : "UNDER"}
                          </span>
