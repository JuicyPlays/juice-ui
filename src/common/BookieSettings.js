...
const BookieSettings = ({ selectedBooks, onToggleBook, onToggleAll, label = "Sportsbooks", options = null, singleMode = false }) => {
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        {singleMode ? (
          <>
            {(() => {
              const singleSelectedKey = selectedBooks.length > 0 ? selectedBooks[0].toLowerCase() : null;
              const logoUrl = singleSelectedKey ? BOOK_CONFIG[singleSelectedKey]?.logo : null;
              ...
              return (
                <>
                  {logoUrl ? (
                    ...
                    >
                      {(singleSelectedKey === "juice_ml" || singleSelectedKey === "juiceml") ? "⚡" : singleSelectedLabel.charAt(0)}
                    </div>
                  )}
      ...
      {open && createPortal(
        ...
        >
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            >
              {label === "Sportsbooks" ? "Choose which books to compare" : `Select a ${label.toLowerCase()}`}
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  {logoUrl ? (
                    ...
                    >
                      {(bookKey.toLowerCase() === "juice_ml" || bookKey.toLowerCase() === "juiceml") ? "⚡" : displayName.charAt(0)}
                    </div>
                  )}
