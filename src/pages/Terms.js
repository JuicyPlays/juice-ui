    ...
    content: [
      {
        type: "text",
        value:
          "JuicyPlays is an algorithmic esports analytics platform that provides:",
      },
      {
        type: "list",
        items: [
    ...
    content: [
      {
        type: "text",
        value:
          "Sports betting and DFS involve significant financial risk. You acknowledge that:",
      },
      {
        type: "list",
        items: [
    ...
    <div style={pg.root}>
      ...
      <nav style={pg.nav}>
        ...
        <div style={pg.navLinks}>
          <Link to="/privacy" style={pg.navLink}>
            Privacy Policy
          </Link>
          <Link to="/home" style={pg.navLinkPrimary}>
            ← Back to Home
          </Link>
        </div>
      </nav>
      ...
      <header style={pg.hero}>
        ...
        <p style={pg.heroSub}>
          Please read these terms carefully before using JuicyPlays. They govern
          your access to our platform and services.
        </p>
      ...
      <footer style={pg.footer}>
        <span style={pg.footerText}>
          © 2026 JuicyPlays. All Rights Reserved.
        </span>
        <div style={pg.footerLinks}>
          <Link to="/terms" style={pg.footerLink}>
            Terms & Conditions
          </Link>
          <span style={pg.footerDivider}>·</span>
          <Link to="/privacy" style={pg.footerLink}>
            Privacy Policy
          </Link>
        </div>
      </footer>
