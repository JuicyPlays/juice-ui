    ...
    content: [
      {
        type: "text",
        value:
          "Your data is used exclusively to operate and improve our platform:",
      },
      {
        type: "list",
        items: [
    ...
    <div style={pg.root}>
      ...
      <nav style={pg.nav}>
        ...
        <div style={pg.navLinks}>
          <Link to="/terms" style={pg.navLink}>
            Terms
          </Link>
      ...
      <header style={pg.hero}>
        ...
        <p style={pg.heroSub}>
          Your data is yours. We're transparent about everything we collect and
          why.
        </p>
